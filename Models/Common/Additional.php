...
namespace Modules\Organization\Models\Common;
...
/**
 * @class Additional
 * @package Modules\Organization\Models\Common
 */
class Additional extends Model implements Auditable
{
    ...
    {
        return \Modules\Organization\Database\Factories\Common/AdditionalFactory::new();
    }
    */
