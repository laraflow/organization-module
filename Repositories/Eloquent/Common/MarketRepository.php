...
namespace Modules\Organization\Repositories\Eloquent\Common;
 ...
 * @package Modules\Organization\Repositories\Eloquent\Common
 */
class MarketRepository extends EloquentRepository
{
    /**
